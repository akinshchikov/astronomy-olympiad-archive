...
Текущий публичный snapshot по коммитимым артефактам обновлён на `2026-09-24`:

- настроенные seed-источники: `54`
- обнаруженные публичные документы: `4053`
- строки в `olympiads_index.csv`: `793`
- уникальные публичные файлы в `files_index.csv`: `4175`
- relation groups: `740`
- семейств с индексированными локальными файлами: `28`
- семейств в `olympiads_index.csv`: `33`
